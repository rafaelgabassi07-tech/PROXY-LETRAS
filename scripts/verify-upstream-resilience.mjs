...
assert.ok(service.includes("cacheKey('search-v12-artwork-fast'"), 'v12 artwork-fast cache namespace missing');
...
console.log('UPSTREAM_RESILIENCE_OK: 503 requires zero completed providers; LRCLIB catalog resolver + Vagalume excerpt-without-apikey fallback + v12 artwork-fast cache verified');
