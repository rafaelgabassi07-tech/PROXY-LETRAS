...
if (pkg.version !== '2.10.0') failures.push(`Expected 2.10.0, got ${pkg.version}`);
...
for (const required of ['buildRemoteQueries', 'lyricsMatchQuality', 'sameSongConfidence', 'songMatchesRequest', 'mergeResultMetadata', 'diceSimilarity', 'search-v6-dual', "['letras_mus_br', 'vagalume']", 'providersUsed', 'imageUrl']) {
