...
if (pkg.version !== '2.11.2') failures.push(`Expected 2.11.2, got ${pkg.version}`);
...
for (const required of ['buildRemoteQueries', 'lyricsMatchQuality', 'sameSongConfidence', 'songMatchesRequest', 'mergeResultMetadata', 'diceSimilarity', 'search-v10-artwork-enrichment', "['lrclib', 'vagalume']", 'providersUsed', 'providersCompleted', 'providersSkipped', 'providerErrors', 'cacheStatus', 'bypass-partial', 'imageUrl']) {
