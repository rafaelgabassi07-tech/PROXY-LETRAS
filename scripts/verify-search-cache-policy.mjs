...
assert.ok(service.includes("cacheKey('search-v9-catalog-resolver'"), 'search cache namespace was not invalidated');
...
console.log('CACHE_POISON_REGRESSION_OK: partial/empty responses bypass cache; valid results cache; v9 namespace active; 503 requires zero completed upstreams');
