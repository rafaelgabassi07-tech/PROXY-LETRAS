...
assert.ok(service.includes("cacheKey('search-v10-artwork-enrichment'"), 'search cache namespace was not invalidated');
...
console.log('CACHE_POISON_REGRESSION_OK: partial/empty responses bypass cache; valid results cache; v10 artwork namespace active; 503 requires zero completed upstreams');
